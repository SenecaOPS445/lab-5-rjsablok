...
def write_file_list(file_name, list_of_lines):
    """
    Takes a string and list, writes all items from the list to the file where each item is one line.
    """
...
def copy_file_add_line_numbers(file_name_read, file_name_write):
    """
    Takes two strings, reads data from the first file, writes data to the new file, and adds line numbers.
    """
